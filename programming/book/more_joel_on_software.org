...
#+BEGIN_QUOTE
巨型公司用一种不合理的方式操纵它们的公众形象――比方说，他们是一家计算机公司，那么与反抗独裁有什么关系呢？真是活见鬼――成功地创造出一种自我认同的文化，使得全世界各地购买计算机的用户感觉他们买的并不仅仅是一台计算机，觉得自己通过购买而参加到了一场运动中。
...
#+BEGIN_QUOTE
蘩特卡洛方法是一种基于「随机数」的计算方法，即先确定一个随机事件，然后重复进行多次的随机实验，对结果进行统计平均，以随机事件出现的概率作为问题的近似解。这种方法源于美国在第二次世界大战中研制原子弹的「曼哈顿计划」。该计划的牛持人之一、数学家冯ヺ诺伊曼用驰名世界的赌城――摩纳哥的 Monte Carlo 来命名这种方法。
#+END_QUOTE
