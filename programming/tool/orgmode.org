...
#+CAPTION: 不输出代码块（直接嵌入生成的文件，不用每次输出时重新生成）
#+BEGIN_SRC code
...
#+BEGIN_SRC code
\#+BEGIN_SRC plantuml :file ../images/.svg
...
#+CAPTION: 示例
#+BEGIN_SRC code
\#+BEGIN_SRC plantuml :file ../images/工作日志_0505_01.svg
!include ../styles/plantuml-style
...
[[http://plantuml.com/skinparam.html][skinparam]]
...
[[http://sdntutorials.com/steps-to-install-plantuml-on-windows-7/][Steps To Install PlantUML On Windows 7]] \\
