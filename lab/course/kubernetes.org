...
- kubelet
  ...
  - kubelet is the main kubernetes agent on the node (pretty much is the node)
    ...
    - a pod is just a bunch of containers packaged together as a single unit
      ...
      - because it is interacing with a container
...
- kube proxy
  ...
  - makes sure every pod get's it's ip
...
file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_202902_rwb6NU.png
...
file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_203208_jDExm4.png
...
file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_203611_C3Fuu0.png

- node goes down

file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_203648_ajXxvQ.png
...
- what actually is a pod
  ...
  - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_204247_XeWH4M.png
  - if the use case for containers are tightly coupled and need access to the same resources

    - stick them in the same pod

    - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_204413_q0l134.png

    - if the use case can be loosely coupled, stick them in separate pods in couple them over the networks

    - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_204539_t4x81j.png
	...
	- add/remove pod replicas
      ...
      - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_204709_iAeHa3.png
  ...
  - example of a multi-container pod
    ...
    - two or more complimentary containers
      ...
      - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_205121_fc31Rc.png

      - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_205155_iwHUeu.png
...
- pods are atomic
  ...
  - you cannot have a single pod spead over multiple nodes

  - pods's lifecycle

    - they are born, live and die. you don't bring one back to life

    - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_205509_7BGlRp.png
...
- pods die and come back up somewhere else in the cluster (on a different node possibly)
  ...
  - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_210400_X7Jizk.png
...
- labels
  ...
  - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_210806_yR1gZf.png

  - when we are updating can remove the tag on the service that makes it exclusive to servicing one version

  - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_210929_ZDY4Ij.png

    - load balancing across them all until we are ready to be fully on the new version

  - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_211024_HEbPA3.png
...
- our infrastructure = masters and nodes
  - file://wsl$/Ubuntu-18.04/home/erauner12/pkb/lab/course/kubernetes.org_20200415_211946_63N0dm.png
...
- rest objects in kubernets api
  ...
  - replciaiton controllers
    - old

  - deployments
    - RC, roling updates, rollbacks
